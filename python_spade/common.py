...
# --- Efeito viral ---
VIRAL_BASE_PROB = 0.15          # probabilidade base de viralizar (0.15 C0 e C2 / 0.50 C1 / 0.05 C3)
VIRAL_IMPACT_THRESHOLD = 0.18   # impacto mínimo para considerar um conteúdo “viralizável”
VIRAL_MAX_EXTRA_TARGETS = 2     # máximo de alvos extras na viralização (2 C0 / 10 C1, C2 e C3)
...
COST_FAKENEWS_PER_TARGET = 4 # 4 em C0, C2 e C3 / 1 em C1
...
NEWS_RATIO = 0.70   # C0 = 70% / C1 10% / C2 50% / C3 90%
FAKE_RATIO = 0.30   # C0 = 30% / C1 90% / C2 50% / C3 10%
...
PARTY_PERCENTAGES = {
    "PED": 0.10, # 10% C0 e C1 / 40% C2 / 5% C3
    "PDD": 0.15, # 15% C0 e C1 / 5% C2 e C3
    "PCE": 0.40, # 40% C0 e C1 / 5% C2 / 60% C3
    "PDE": 0.15, # 15% C0 e C1 / 5% C2 e C3
    "PEE": 0.10, # 10% C0 e C1 / 40% C2 / 5% C3
    "SPD": 0.10, # 10% C0 e C1 / 5% C2 / 20% C3
}
